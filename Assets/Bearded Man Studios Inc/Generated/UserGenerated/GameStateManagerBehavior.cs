...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class GameStateManagerBehavior : NetworkBehavior
	{
		...
		{
			Initialize(new GameStateManagerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new GameStateManagerNetworkObject(networker, this, createCode, metadata);
		}
