			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case GameStateManagerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GameStateManagerNetworkObject(networker, id, frame);
						break;
					case GuyWithMovementNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GuyWithMovementNetworkObject(networker, id, frame);
						break;
