...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		[Obsolete("Use InstantiateGameStateManager instead, its shorter and easier to type out ;)")]
		public GameStateManagerBehavior InstantiateGameStateManagerNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			...
			var netBehavior = go.GetComponent<GameStateManagerBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
		...
		[Obsolete("Use InstantiateGuyWithMovement instead, its shorter and easier to type out ;)")]
		public GuyWithMovementBehavior InstantiateGuyWithMovementNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			...
			var netBehavior = go.GetComponent<GuyWithMovementBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
		...
		public GameStateManagerBehavior InstantiateGameStateManager(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(GameStateManagerNetworkObject[index]);
			var netBehavior = go.GetComponent<GameStateManagerBehavior>();
		...
		public GuyWithMovementBehavior InstantiateGuyWithMovement(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(GuyWithMovementNetworkObject[index]);
			var netBehavior = go.GetComponent<GuyWithMovementBehavior>();
